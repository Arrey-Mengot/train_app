...
class Authentication {
  ...
  Future<void> createUserWithEmailAndPassword(String email, String password,BuildContext ctx )async{
    try{
  ...
  Future<void> signInWithEmailAndPassword(String email, String password, BuildContext ctx)async{
    try{
...
final authStateProvider = StreamProvider<User?>((ref) => ref.watch(authenticationProvider).authStateChange);
